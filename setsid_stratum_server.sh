...
addport_full=${dir}'/multipool/yiimp_multi/ubuntu/addport-full'
addport_lowdiff=${dir}'/multipool/yiimp_multi/ubuntu/addport-lowdiff'
addport_zenx=${dir}'/multipool/yiimp_multi/ubuntu/addport-zenx'
