...
addport_full=${dir}'/multipool/yiimp_multi/ubuntu/addport_full'
addport_lowdiff=${dir}'/multipool/yiimp_multi/ubuntu/addport_lowdiff'
addport_zenx=${dir}'/multipool/yiimp_multi/ubuntu/addport_zenx'
...
cat $addport_full | setsid ssh ${SSH_OPTIONS} ${StratumUser}@${StratumServer} 'cat > /tmp/addport-full'
cat $addport_lowdiff | setsid ssh ${SSH_OPTIONS} ${StratumUser}@${StratumServer} 'cat > /tmp/addport-lowdiff'
cat $addport_zenx | setsid ssh ${SSH_OPTIONS} ${StratumUser}@${StratumServer} 'cat > /tmp/addport-zenx'
